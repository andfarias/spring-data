...
import br.com.alura.spring.data.projection.FuncionarioProjecao;
...
public class RelatoriosService {
	...
	private void buscaFuncionarioNomesalarioMariorData(Scanner scanner) {
		...
		// funcionarioRepository.findNomeSalarioMaiorDataContratacao(nome, salario,
		// localDate);
		List<Funcionario> funcionarios = funcionarioRepository.findByNomeAndSalarioGreaterThanAndDataContratacao(nome,
				salario, localDate);
	...
	private void pesquisaFuncionarioSalario() {
		...
		list.forEach(f -> System.out
				.println("Funcionario: id: " + f.getId() + " | nome: " + f.getNome() + " | salario: " + f.getSalario()));
	}
